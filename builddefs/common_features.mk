  ...
  ifeq ($(strip $(EEPROM_DRIVER)), custom)
    ...
    ifeq ($(PLATFORM),AVR)
      ...
      ifneq ($(filter %_STM32F072xB %_STM32F042x6, $(MCU_SERIES)_$(MCU_LDSCRIPT)),)
        ...
        COMMON_VPATH += $(DRIVER_PATH)/flash
        SRC += eeprom_driver.c eeprom_legacy_emulated_flash.c legacy_flash_ops.c
      else ifneq ($(filter $(MCU_SERIES),STM32F1xx STM32F3xx STM32F4xx STM32L4xx STM32G4xx WB32F3G71xx WB32FQ95xx GD32VF103 SN32F240 SN32F240B SN32F240C SN32F260 SN32F290),)
