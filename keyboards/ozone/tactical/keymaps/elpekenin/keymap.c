...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_65_iso(
                ...
                EE_CLR,  XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX,   XXXXX, RM_NEXT, XXXXX,   XXXXX,
                XXXXX,   XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, RM_HUEU, XXXXX, XXXXX,   RM_VALU, XXXXX,
                XXXXX,   XXXXX, XXXXX,                      XXXXX,               XXXXX, KC_TRNS, XXXXX, RM_SPDD, RM_VALD, RM_SPDU
            )
};
