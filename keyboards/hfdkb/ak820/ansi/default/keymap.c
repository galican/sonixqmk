...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT(
        ...
        _______, _______,  _______,  _______,  _______,  _______, _______, _______, _______, _______, _______, _______,  _______,  RM_TOGG,  _______,  _______, _______,  _______,  _______,
        _______, _______,  _______,  _______,  _______,  _______, _______, _______, _______, _______, NK_TOGG, _______,  _______,  RM_NEXT,  _______,  _______, _______,  _______,  _______,
